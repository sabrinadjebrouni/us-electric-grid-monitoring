...
with DAG(
    dag_id="fetch_region_data_hourly",
    schedule=CronDataIntervalTimetable("0 13 * * *", timezone="UTC"),
    ...
    def fetch_and_upload_to_gcs(data_interval_start=None):
        ...
        start_period = data_interval_start.format('YYYY-MM-DD') #data_interval_start equals the time that the dag is trigerred 
        end_period = start_period ## when start = end the api return all data of the day from T00 to T23
    ...
    '''trigger_spark_job = TriggerDagRunOperator(
        ...
        trigger_dag_id="spark_job_transform_region",
        conf={
            "api_name": API_NAME,
